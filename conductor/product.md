...
- [ ] Web UI dashboard
- [ ] Fine-grained tool permissions\n\n# Product Vision: Nova Evolution\n\nNova is an industrial-grade, local-first autonomous AI agent. The evolution focuses on hardening the core reasoning loop, integrating advanced Edge AI capabilities, and ensuring production-level reliability through comprehensive testing and failure handling.\n\n## Core Objectives\n- **Intelligence & Reasoning:** Transition from a simple ReAct loop to a multi-step planning graph with self-critique and confidence scoring.\n- **Model Layer:** [COMPLETED] Implementation of a dynamic Model Router and full integration of Google Edge AI for offline-first vision.\n- **Memory & Learning:** [COMPLETED] Tiered memory (Short-term, Long-term/ChromaDB, Episodic) with smart context pruning and episodic recall.\n- **Safety & Recovery:** Explicit failure states, circuit breakers, and dry-run simulation modes.\n- **Testing & Validation:** Automated test generation, chaos testing, and regression detection.\n- **Performance & UX:** Optimized token usage, execution replay, and a 'live plan tree' visualization.
